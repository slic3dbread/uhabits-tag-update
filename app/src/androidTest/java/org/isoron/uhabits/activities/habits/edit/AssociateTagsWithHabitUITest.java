...
public class AssociateTagsWithHabitUITest {
    ...
    public void associateTagsWithHabitUITest() {
        ...
        ViewInteraction appCompatCheckedTextView = onView(
                allOf(withId(android.R.id.text1), withSpinnerText("Hello"), isDisplayed()));
        ...
        ViewInteraction appCompatButton3 = onView(
                allOf(withId(R.id.buttonDiscard), withText("Discard"), isDisplayed()));
